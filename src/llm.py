...
class Small_LLM_Model:
    ...
    model_name: str, default="Qwen/Qwen3-0.6B"
        ...
        Feel free to replace it with one of the
    ...
    dtype: torch.dtype | None, default=None
        Numerical precision.  When using a GPU or
        MPS we default to ``float16`` to keep memory
    ...
    def get_logits_from_input_ids(self, input_ids: list[int]) -> list[float]:
        ...
        (no softmax) for the next token as a list of floats.
        """
        ...
        # in the sequence for the batch (batch size 1)
    ...
    def get_path_to_vocabulary_json(self) -> str:
        ...
        vocab_path: str = hf_hub_download(
